...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "express", "mini-tools", "serve-content"], factory);
    }
    ...
    var Server4Test = /** @class */ (function () {
        function Server4Test(opts) {
            this.app = express();
            this.opts = opts;
        }
        Server4Test.prototype.start = function () {
            return __awaiter(this, void 0, void 0, function () {
                var server, baseUrl, optsGenericForFiles;
        ...
        Server4Test.prototype.directServices = function () {
            return [];
        };
        Server4Test.prototype.closeServer = function () {
            return __awaiter(this, void 0, void 0, function () {
                var server;
                return __generator(this, function (_a) {
                    switch (_a.label) {
